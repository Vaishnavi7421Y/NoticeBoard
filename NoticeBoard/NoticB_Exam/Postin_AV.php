                  ...
                  <form  action="#" method="POST">
                      ...
                      <div class="panel-footer">
                            <div class="btn-signup">
                             <center> <button type="submit" name="submit" class="btn " data-toggle="tooltip"  title="Post in Art-Villa .">Post</button>
                              <button type="Reset" name="Reset" class="btn" data-toggle="tooltip"  title="Reset all fields.">Reset</button>
                               <a href="studentdash.php"><button type="button" name="close" class="btn" data-toggle="tooltip"  title="Goto Dashboard.">Close</button></a></center>
                            </div>
                          </div>
                        </div>
                        </form>
