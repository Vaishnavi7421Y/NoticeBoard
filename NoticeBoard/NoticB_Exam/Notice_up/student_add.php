...
<head>
    ...
    <title>Add Student Records |Devise & Sight Notices </title>
                  ...
                  <form  action="#" method="POST">
                      ...
                      <div class="panel-footer">
                            <div class="btn-signup">
                             <center> <button type="submit" name="submit" class="btn " data-toggle="tooltip"  title="Add records of students.">Add</button>
